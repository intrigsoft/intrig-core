...
```jsx
import React from 'react';
import { useCreateUser, isPending, isSuccess, isError } from '@intrig/next';
...
```jsx
import React from 'react';
import { useGetUserProfile, isPending, isSuccess } from '@intrig/next';
...
import { useGetData, isPending, isSuccess, isError } from '@intrig/next';
...
```jsx
import React from 'react';
import { useGetDetailedData, isPending, isSuccess } from '@intrig/next';
...
```jsx
import React, { useState, useEffect } from 'react';
import { useSearchUsers, isPending } from '@intrig/next';
...
import { useUpdateUser, isPending, isError } from '@intrig/next';
