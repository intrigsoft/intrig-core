...
```jsx
import React, { useState } from 'react';
import { useSearchUsers, isInit, isPending, isSuccess } from '@intrig/next';
...
```jsx
import React, { useState } from 'react';
import { useGetUserDetails, isInit, isPending, isSuccess } from '@intrig/next';
...
import { useGetData, isInit, isPending, isSuccess } from '@intrig/next';
...
```jsx
import React from 'react';
import { useGetData, isInit, isPending, isSuccess, isError } from '@intrig/next';
...
```jsx
import React, { useState } from 'react';
import { useSubmitForm, isInit, isPending, isSuccess } from '@intrig/next';
...
```jsx
import React, { useState } from 'react';
import { useGetAdvancedData, isInit, isPending, isSuccess } from '@intrig/next';
