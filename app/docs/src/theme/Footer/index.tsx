        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <img src="/img/logo.svg" alt="Intrig Logo" className="h-8 w-16" />
              <span className="text-xl font-bold text-white"></span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              API Development Made Simple. Generate typed React hooks, searchable docs, 
              and developer workbenches from your OpenAPI specifications.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              Copyright © {currentYear} Intrig. Built with{' '}
              <a 
