...
const mockSourceStats = {
  "1": { endpoints: 15, dataTypes: 8, operations: 24 },
  "2": { endpoints: 12, dataTypes: 6, operations: 18 },
  "3": { endpoints: 8, dataTypes: 4, operations: 12 },
  "4": { endpoints: 13, dataTypes: 7, operations: 20 }
};
